...
const ThirdParty = () => {
  return (
    <div className="border-t-gray-20 border-b-gray-20 mt-12 md:mt-[71px] flex flex-col justify-center  border-t border-solid border-b">
      <div className="max-container padding-container flexCenter w-full flex-col max-md:max-w-full my-12 md:my-[71px]">
        ...
        <div className="bg-orange-20 self-stretch flex flex-col mt-2 pl-8 pr-20 pt-8 rounded-2xl items-end max-md:max-w-full max-md:px-5">
