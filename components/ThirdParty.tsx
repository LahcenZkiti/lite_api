...
const ThirdParty = () => {
  return (
    <section className="border-t-gray-20 border-b-gray-20 mt-12 md:mt-[71px] flex flex-col justify-center  border-t border-solid border-b"  data-aos="fade-up">
      <div className="max-container padding-container flexCenter w-full flex-col max-md:max-w-full my-12 md:my-[71px]">
        <h2 className="semibold-40">Third-party solutions</h2>
        <p className="medium-14 mb-14 mx-auto max-w-[635px] max-md:max-w-full">
        ...
        <div className="self-stretch mt-20 max-md:max-w-full max-md:mt-10">
          <div className="gap-[8px] flex max-md:flex-col max-md:items-stretch max-md:gap-0">
            <div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0"  data-aos="fade-right">
            ...
            <div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0"  data-aos="fade-left">
        ...
        <div className="bg-orange-20 self-stretch flex flex-col mt-2 pl-8 pr-20 pt-8 rounded-2xl items-end max-md:max-w-full max-md:px-5"  data-aos="fade-up">
